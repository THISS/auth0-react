...
var u = function (e) {
  ...
  V = l.document,
  w = F(V) && F(V.createElement),
  X = function (e) {
    return w ? V.createElement(e) : {};
  },
  G =
    !g &&
    !d(function () {
  ...
  k = l['__core-js_shared__'] || H('__core-js_shared__', {}),
  L = Function.toString;
...
var T,
  ...
  j = function (e) {
    return (
      'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++_ + D).toString(36)
    );
  },
  P = z('keys'),
  M = function (e) {
...
var oe,
  ...
  ke = He && !Symbol.sham && 'symbol' == typeof Symbol.iterator,
  Le = z('wks'),
  Te = l.Symbol,
  Ee = ke ? Te : (Te && Te.withoutSetter) || j,
  Ne = function (e) {
    return (
      Z(Le, e) ||
        (He && Z(Te, e) ? (Le[e] = Te[e]) : (Le[e] = Ee('Symbol.' + e))),
      Le[e]
    );
  },
  Ye = Ne('match'),
  ...
  je = Math.min,
  Pe = ze('startsWith'),
  Me = !(Pe || ((oe = _e(String.prototype, 'startsWith')), !oe || oe.writable));
We(
  { target: 'String', proto: !0, forced: !Me && !Pe },
  {
    startsWith: function (e) {
      var t = String(B(this));
      Ke(e);
      var n = pe(je(arguments.length > 1 ? arguments[1] : void 0, t.length)),
        i = String(e);
...
vt || se(Object.prototype, 'toString', St, { unsafe: !0 });
var Ut,
  Zt =
    Object.keys ||
    function (e) {
...
var Rt =
  ...
  Tt = function (e) {
    ...
    Z(t, e) || Lt(t, e, { value: kt.f(e) });
  },
  Et = J.f,
  Nt = Ne('toStringTag'),
  Yt = function (e, t, n) {
    e &&
      !Z((e = n ? e : e.prototype), Nt) &&
      Et(e, Nt, { configurable: !0, value: t });
  },
  Kt = [].push,
  Ot = function (e) {
    var t = 1 == e,
  ...
  fn = function (e, t) {
    ...
    return (
      jt(n, { type: 'Symbol', tag: e, description: t }),
      g || (n.description = t),
      n
    );
  },
  ...
  pn = function (e, t, n) {
    ...
    return (
      ...
      Z(on, i)
        ? (n.enumerable
            ? (Z(e, _t) && e[_t][i] && (e[_t][i] = !1),
              (n = Rt(n, { enumerable: h(0, !1) })))
            : (Z(e, _t) || tn(e, _t, h(1, {})), (e[_t][i] = !0)),
          gn(e, i, n))
        : tn(e, i, n)
    );
  },
  ...
  yn = function (e) {
    ...
    return (
      ...
      (!(n || !Z(this, t) || !Z(on, t) || (Z(this, _t) && this[_t][t])) || n)
    );
  },
  bn = function (e, t) {
    var n = C(e),
    ...
    if (n !== Mt || !Z(on, i) || Z(cn, i)) {
      var r = en(n, i);
      return (
        !r || !Z(on, i) || (Z(n, _t) && n[_t][i]) || (r.enumerable = !0), r
      );
    }
  },
  mn = function (e) {
...
if (
    ...
    (se(
      (qt = function () {
        ...
        var e =
          ...
          n = function (e) {
            this === Mt && n.call(cn, e),
              Z(this, _t) && Z(this[_t], t) && (this[_t][t] = !1),
              gn(this, t, h(1, e));
          };
  ...
  We({ global: !0, wrap: !0, forced: !He, sham: !He }, { Symbol: qt }),
  zt(Zt(un), function (e) {
    Tt(e);
  }),
  We(
    { target: 'Symbol', stat: !0, forced: !He },
    {
      for: function (e) {
        var t = String(e);
...
if (
    ...
    Un = function () {
      var e =
          arguments.length < 1 || void 0 === arguments[0]
            ? void 0
            : String(arguments[0]),
        t = this instanceof Un ? new Fn(e) : void 0 === e ? Fn() : Fn(e);
      return '' === e && (Sn[t] = !0), t;
    };
  Ve(Un, Fn);
  var Zn = (Un.prototype = Fn.prototype);
  Zn.constructor = Un;
  var Vn = Zn.toString,
  ...
  Cn(Zn, 'description', {
    ...
    We({ global: !0, forced: !0 }, { Symbol: Un });
}
Tt('hasInstance'),
...
[].keys &&
  ('next' in (An = [].keys())
    ? (xn = kn(kn(An))) !== Object.prototype && (Gn = xn)
    : (Tn = !0)),
  null == Gn && (Gn = {}),
  Z(Gn, Ln) ||
    W(Gn, Ln, function () {
...
var En = { IteratorPrototype: Gn, BUGGY_SAFARI_ITERATORS: Tn },
  Nn = {},
  Yn = En.IteratorPrototype,
  Kn = function () {
    return this;
  },
  On =
  ...
  Pn = function (e, t, n, i, r, o, c) {
    !(function (e, t, n) {
      var i = t + ' Iterator';
      (e.prototype = Rt(Yn, { next: h(1, n) })), Yt(e, i, !1), (Nn[i] = Kn);
    })(n, t, i);
    var s,
      a,
      u,
    ...
    if (
      (y &&
        ...
        zn !== Object.prototype &&
          s.next &&
          (kn(s) !== zn &&
            (On ? On(s, zn) : 'function' != typeof s[Dn] && W(s, Dn, jn)),
          Yt(s, d, !0))),
      'values' == r &&
        I &&
        'values' !== I.name &&
      ...
      if (
        ...
        for (u in a) (_n || g || !(u in f)) && se(f, u, a[u]);
      else We({ target: t, proto: !0, forced: _n || g }, a);
    return a;
  },
  Mn = Qn.charAt,
  qn = ce.set,
...
var ei = function (e) {
  ...
  ii = Array.prototype,
  ri = function (e) {
    return void 0 !== e && (Nn.Array === e || ii[ni] === e);
  },
  oi = Ne('iterator'),
  ci = function (e) {
    if (null != e) return e[oi] || e['@@iterator'] || Nn[Ft(e)];
  },
  si = Ne('iterator'),
  ai = !1;
try {
...
if ((Zi && kn(mi) !== Bi && On(mi, Bi), g && !Z(Bi, Si)))
  for (fi in (pi(Bi, Si, {
    get: function () {
...
var Wi = Ne('unscopables'),
  Hi = Array.prototype;
null == Hi[Wi] && J.f(Hi, Wi, { configurable: !0, value: Rt(null) });
var ki = function (e) {
    Hi[Wi][e] = !0;
  },
      ...
      if (
        ...
        h ||
          (((a = t(function (t, n) {
            ...
            return null != n && _i(n, r[o], { that: r, AS_ENTRIES: i }), r;
          })).prototype = s),
          (s.constructor = a)),
        ...
        getConstructor: function (e, t, n, i) {
          var r = e(function (e, o) {
              Di(e, r, t),
                ...
                g || (e.size = 0),
                null != o && _i(o, e[i], { that: e, AS_ENTRIES: n });
            }),
            o = er(t),
            c = function (e, t, n) {
              var i,
...
(Nn.Arguments = Nn.Array), ki('keys'), ki('values'), ki('entries');
var or = Ne('iterator'),
  cr = Ne('toStringTag'),
  sr = rr.values;
for (var ar in tr) {
...
'function' != typeof Sr.Promise
  ? (Sr.Promise = yr)
  : Sr.Promise.prototype.finally
  ? Sr.Promise.allSettled || (Sr.Promise.allSettled = fr)
  : (Sr.Promise.prototype.finally = gr),
  (function (e) {
    function t() {}
    function n(e, t) {
      if (
...
var Zr = s(
                  ...
                  case 0:
                    return (
                      ...
                      null === (c = n.getItem(o))
                        ...
                        ? [3, 2]
                        : [4, Ur.default().lock(c.iat)]
                    );
                  case 1:
                    i.sent(),
                      this.acquiredIatSet.delete(c.iat),
                      n.removeItem(o),
                      Ur.default().unlock(c.iat),
                      e.notifyWaiters(),
                      (i.label = 2);
                  case 2:
                    return [2];
  ...
  Xr = { name: 'auth0-spa-js', version: '1.13.5' },
  Gr = (function (e) {
    function n(t, i) {
          ...
          if (
            ...
            n && n.close(),
              e.data.response.error
                ? r(Gr.fromPayload(e.data.response))
                : i(e.data.response),
              clearTimeout(a),
              window.removeEventListener('message', c, !1),
              setTimeout(s, 2e3);
    ...
    return r(void 0, void 0, void 0, function () {
      ...
      return o(this, function (o) {
        switch (o.label) {
          ...
          case 2:
            return (r = o.sent()), (a = { ok: r.ok }), [4, r.json()];
          case 3:
            return [2, ((a.json = o.sent()), a)];
        }
        var u, l, d, g;
      });
    });
  },
  Or = function (e, t, i, r, o, c) {
    void 0 === c && (c = 1e4);
    var s,
    ...
    return o(this, function (o) {
      switch (o.label) {
        ...
        case 1:
          ...
          o.label = 2;
        case 2:
          return o.trys.push([2, 4, , 5]), [4, Or(e, n, c, s, a, t)];
        case 3:
...
var Pr = (function () {
  ...
  oo = function (e) {
    ...
    var t = (function (e) {
      ...
      var o = JSON.parse(Nr(i)),
        c = { __raw: e },
        s = {};
      return (
        Object.keys(o).forEach(function (e) {
          (c[e] = o[e]), ro.includes(e) || (s[e] = o[e]);
        }),
        {
    ...
    if (e.max_age && !io(t.claims.auth_time))
      throw new Error(
...
var so = co.get,
  ...
  go = {
    get: function (e) {
      var t = lo.get(e);
      return t || lo.get('_legacy_' + e);
    },
    save: function (e, t, n) {
      var i = {};
      'https:' === window.location.protocol && (i = { secure: !0 }),
        (i.expires = n.daysUntilExpire),
        ao('_legacy_' + e, JSON.stringify(t), i),
        lo.save(e, t, n);
    },
    remove: function (e) {
      lo.remove(e), lo.remove('_legacy_' + e);
    },
  },
  fo = {
    get: function (e) {
  ...
  Uo = (function () {
    function e(e) {
      ...
      if (
        ...
        (this.cookieStorage = !1 === e.legacySameSiteCookie ? lo : go),
        (this.sessionCheckExpiryDays = e.sessionCheckExpiryDays || 1),
        !Fo(this.cacheLocation))
      )
        throw new Error('Invalid cache location "' + this.cacheLocation + '"');
      var r,
        o,
        c = e.useCookiesForTransactions ? this.cookieStorage : fo;
      (this.cache = Fo(this.cacheLocation)()),
        (this.scope = this.options.scope),
        (this.transactionManager = new no(c)),
        (this.domainUrl = 'https://' + this.options.domain),
        (this.tokenIssuer =
          ((r = this.options.issuer),
          (o = this.domainUrl),
          r ? (r.startsWith('https://') ? r : 'https://' + r + '/') : o + '/')),
        (this.defaultScope = Dr(
          'openid',
          void 0 !==
            (null ===
              (n =
        ...
        this.options.useRefreshTokens &&
          (this.scope = Dr(this.scope, 'offline_access')),
        'undefined' != typeof window &&
          window.Worker &&
          this.options.useRefreshTokens &&
    ...
    return (
      ...
      (e.prototype._getParams = function (e, t, r, o, c) {
        ...
        return n(n(n({}, a), e), {
          scope: Dr(this.defaultScope, this.scope, e.scope),
          response_type: 'code',
          response_mode: 'query',
          state: t,
          nonce: r,
          ...
          r(this, void 0, void 0, function () {
            ...
            return o(this, function (r) {
              return (
                ...
                (n = Dr(this.defaultScope, this.scope, e.scope)),
                [
                  2,
                  (i = this.cache.get(
                    new Pr({
          ...
          return o(this, function (n) {
            switch (n.label) {
              ...
              case 2:
                return n.sent(), [3, 4];
              case 3:
                if (((t = n.sent()), !wr.includes(t.error))) throw t;
                return [3, 4];
              case 4:
                return [2];
            }
          ...
          r(this, void 0, void 0, function () {
            ...
            return o(this, function (g) {
              switch (g.label) {
                ...
                case 7:
                  return [4, Bo.releaseLock('auth0.lock.getTokenSilently')];
                case 8:
                  return g.sent(), [7];
                case 9:
                  return [3, 11];
              ...
              switch (i.label) {
                case 0:
                  return (
                    ...
                    (e.scope = Dr(this.defaultScope, this.scope, e.scope)),
                    (t = n(n({}, Vr), t)),
      ...
      (e.prototype._getTokenFromIFrame = function (e) {
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (o) {
            switch (o.label) {
              case 0:
                return (t = Lr(kr())), (r = Lr(kr())), (c = kr()), [4, Er(c)];
              case 1:
                (s = o.sent()),
                  (a = Yr(s)),
                  (u = this._getParams(
...
var Auth0Provider = function (opts) {
  ...
  var client = React.useState(function () {
    return new Uo(toAuth0ClientOptions(clientOpts));
  })[0];
  ...
  var buildAuthorizeUrl = React.useCallback(
    function (opts) {
      return client.buildAuthorizeUrl(opts);
    },
    [client]
  );
