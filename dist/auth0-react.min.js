!(function (t, e) {
  ...
  var p = function (t) {
    ...
    R = function (t, e) {
      if (!Q(t)) return t;
      var i, n;
      if (e && 'function' == typeof (i = t.toString) && !Q((n = i.call(t))))
        return n;
      if ('function' == typeof (i = t.valueOf) && !Q((n = i.call(t)))) return n;
      if (!e && 'function' == typeof (i = t.toString) && !Q((n = i.call(t))))
        return n;
    ...
    k = {
      f: f
        ...
        : function (t, e) {
            ...
            if (J(t, e)) return V(!Z.f.call(t, e), t[e]);
          },
    },
    N = function (t) {
    ...
    D = h['__core-js_shared__'] || z('__core-js_shared__', {}),
    O = Function.toString;
  ...
  var P,
    ...
    st = h.WeakMap;
  if ($) {
    var lt = D.state || (D.state = new st()),
      ut = lt.get,
      at = lt.has,
      It = lt.set;
    (P = function (t, e) {
      return (e.facade = t), It.call(lt, t, e), e;
    }),
      (M = function (t) {
        return ut.call(lt, t) || {};
      }),
  ...
  var dt,
    ...
    yt = B(function (t) {
      ...
      (t.exports = function (t, e, c, o) {
        var r,
          ...
          u = !!o && !!o.noTargetGet;
        'function' == typeof c &&
          ('string' != typeof e || J(c, 'name') || K(c, 'name', e),
          (r = i(c)).source ||
    ...
    vt = function (t, e) {
      var i,
        ...
        c = 0,
        o = [];
      for (i in n) !J(rt, i) && J(n, i) && o.push(i);
      for (; e.length > c; ) J(n, (i = e[c++])) && (~St(o, i) || o.push(i));
      return o;
    },
    xt = [
      'constructor',
    ...
    Wt = function (t, e) {
      for (var i = Jt(e), n = E.f, c = k.f, o = 0; o < i.length; o++) {
        var r = i[o];
        J(t, r) || n(t, r, c(e, r));
      }
    },
    ...
    wt = function (t, e) {
      var i = Yt[Lt(t)];
      return i == Nt || (i != kt && ('function' == typeof e ? m(e) : !!e));
    },
    Lt = (wt.normalize = function (t) {
      return String(t).replace(Ht, '.').toLowerCase();
    }),
    Yt = (wt.data = {}),
    kt = (wt.NATIVE = 'N'),
    Nt = (wt.POLYFILL = 'P'),
    ...
    Kt = function (t, e) {
      var i,
        ...
        l = t.global,
        u = t.stat;
      if ((i = l ? h : u ? h[s] || z(s, {}) : (h[s] || {}).prototype))
        for (n in e) {
          if (
            ((o = e[n]),
            (c = t.noTargetGet ? (r = Et(i, n)) && r.value : i[n]),
    ...
    Ot = tt('wks'),
    Pt = h.Symbol,
    Mt = Dt ? Pt : (Pt && Pt.withoutSetter) || nt,
    jt = function (t) {
      return (
        J(Ot, t) ||
          (zt && J(Pt, t) ? (Ot[t] = Pt[t]) : (Ot[t] = Mt('Symbol.' + t))),
        Ot[t]
      );
    },
    _t = jt('match'),
    qt = function (t) {
      if (
        (function (t) {
          var e;
          return Q(t) && (void 0 !== (e = t[_t]) ? !!e : 'RegExp' == X(t));
        })(t)
      )
  ...
  Kt(
    { target: 'String', proto: !0, forced: !oe && !ce },
    {
      startsWith: function (t) {
        var e = String(v(this));
        qt(t);
        var i = Zt(ne(arguments.length > 1 ? arguments[1] : void 0, e.length)),
          n = String(t);
      ...
      return (
        ge(t) &&
          ...
          (i !== Array && !ge(i.prototype))
            ? Q(i) && null === (i = i[ye]) && (i = void 0)
            : (i = void 0)),
        new (void 0 === i ? Array : i)(0 === e ? 0 : e)
      );
    },
    pe = ht('navigator', 'userAgent') || '',
    he = h.process,
    me = he && he.versions,
    fe = me && me.v8;
  fe
    ? (se = (re = fe.split('.'))[0] + re[1])
    : pe &&
      (!(re = pe.match(/Edge\/(\d+)/)) || re[1] >= 74) &&
      (re = pe.match(/Chrome\/(\d+)/)) &&
      (se = re[1]);
  var Ce = se && +se,
    Fe = jt('species'),
    Ze = jt('isConcatSpreadable'),
    Ve =
      Ce >= 51 ||
      !m(function () {
        var t = [];
  ...
  Kt(
    { target: 'Array', proto: !0, forced: !Ve || !Ue },
    {
      concat: function (t) {
        var e,
          i,
        ...
        for (e = -1, n = arguments.length; e < n; e++)
          if (Xe((o = -1 === e ? r : arguments[e]))) {
            if (l + (c = Zt(o.length)) > 9007199254740991)
              throw TypeError('Maximum allowed index exceeded');
            for (i = 0; i < c; i++, l++) i in o && be(s, l, o[i]);
          } else {
  ...
  Se || yt(Object.prototype, 'toString', Re, { unsafe: !0 });
  var Ae,
    Je =
      Object.keys ||
      function (t) {
    ...
    We = f
      ...
      : function (t, e) {
          N(t);
          for (var i, n = Je(e), c = n.length, o = 0; c > o; )
            E.f(t, (i = n[o++]), e[i]);
          return t;
        },
    He = ht('document', 'documentElement'),
    we = ot('IE_PROTO'),
    Le = function () {},
    Ye = function (t) {
    ...
    ke = function () {
      ...
      ke = Ae
        ...
        : (((e = w('iframe')).style.display = 'none'),
          ...
          t.close(),
          t.F);
      for (var i = xt.length; i--; ) delete ke.prototype[xt[i]];
      return ke();
    };
  rt[we] = !0;
  var Ne =
    ...
    ze = {
      f: function (t) {
        return Ke && '[object Window]' == Ee.call(t)
          ? (function (t) {
              try {
                return Te(t);
              } catch (t) {
    ...
    Pe = function (t) {
      ...
      J(e, t) || Oe(e, t, { value: De.f(t) });
    },
    Me = E.f,
    je = jt('toStringTag'),
    _e = function (t, e, i) {
      t &&
        !J((t = i ? t : t.prototype), je) &&
        Me(t, je, { configurable: !0, value: e });
    },
    qe = [].push,
    $e = function (t) {
      var e = 1 == t,
      ...
      return function (l, u, a, I) {
        for (
          var g,
            ...
            h = 0,
            m = I || Be,
            f = e ? m(l, p) : i || r ? m(l, 0) : void 0;
          p > h;
          h++
        )
          if ((s || h in y) && ((d = B((g = y[h]), h, b)), t))
            if (e) f[h] = d;
            else if (d)
              switch (t) {
                case 3:
    ...
    ti = [$e(0), $e(1), $e(2), $e(3), $e(4), $e(5), $e(6), $e(7)][0],
    ei = ot('hidden'),
    ii = jt('toPrimitive'),
    ni = bt.set,
    ...
    Bi = tt('wks'),
    pi = h.QObject,
    hi = !pi || !pi.prototype || !pi.prototype.findChild,
    mi =
      f &&
      m(function () {
        return (
    ...
    Fi = function (t, e, i) {
      ...
      return (
        ...
        J(gi, n)
          ? (i.enumerable
              ? (J(t, ei) && t[ei][n] && (t[ei][n] = !1),
                (i = Ne(i, { enumerable: V(0, !1) })))
              : (J(t, ei) || ui(t, ei, V(1, {})), (t[ei][n] = !0)),
            mi(t, n, i))
          : ui(t, n, i)
      );
    },
    ...
    Vi = function (t) {
      var e = R(t, !0),
        i = Ii.call(this, e);
      return (
        !(this === oi && J(gi, e) && !J(di, e)) &&
        (!(i || !J(this, e) || !J(gi, e) || (J(this, ei) && this[ei][e])) || i)
      );
    },
    Ui = function (t, e) {
      var i = x(t),
        n = R(e, !0);
      if (i !== oi || !J(gi, n) || J(di, n)) {
        var c = li(i, n);
        return (
          !c || !J(gi, n) || (J(i, ei) && i[ei][n]) || (c.enumerable = !0), c
        );
      }
    },
    Xi = function (t) {
  ...
  if (
      ...
      (yt(
        (ri = function () {
          ...
          var t =
            ...
            i = function (t) {
              this === oi && i.call(di, t),
                J(this, ei) && J(this[ei], e) && (this[ei][e] = !1),
                mi(this, e, V(1, t));
            };
          return f && hi && mi(oi, e, { configurable: !0, set: i }), fi(e, t);
        }).prototype,
        'toString',
        function () {
          return ci(this).tag;
    ...
    Kt(
      ...
      {
        create: function (t, e) {
          return void 0 === e ? Ne(t) : Zi(Ne(t), e);
        },
        defineProperty: Fi,
        defineProperties: Zi,
      ...
      Ri = function () {
        var t =
            arguments.length < 1 || void 0 === arguments[0]
              ? void 0
              : String(arguments[0]),
          e = this instanceof Ri ? new xi(t) : void 0 === t ? xi() : xi(t);
        return '' === t && (Qi[e] = !0), e;
      };
    Wt(Ri, xi);
    var Ai = (Ri.prototype = xi.prototype);
    Ai.constructor = Ri;
    var Ji = Ai.toString,
      Wi = 'Symbol(test)' == String(xi('test')),
      Hi = /^Symbol\((.*)\)[^)]+$/;
    vi(Ai, 'description', {
      configurable: !0,
      get: function () {
        var t = Q(this) ? this.valueOf() : this,
          e = Ji.call(t);
        if (J(Qi, t)) return '';
        var i = Wi ? e.slice(7, -1) : e.replace(Hi, '$1');
        return '' === i ? void 0 : i;
      },
    }),
  ...
  [].keys &&
    ('next' in (Yi = [].keys())
      ? (Li = zi(zi(Yi))) !== Object.prototype && (wi = Li)
      : (Oi = !0)),
    null == wi && (wi = {}),
    J(wi, Di) ||
      K(wi, Di, function () {
  ...
  var Pi = { IteratorPrototype: wi, BUGGY_SAFARI_ITERATORS: Oi },
    Mi = {},
    ji = Pi.IteratorPrototype,
    _i = function () {
      return this;
    },
    qi =
      ...
      ('__proto__' in {}
        ...
        : void 0),
    $i = Pi.IteratorPrototype,
    tn = Pi.BUGGY_SAFARI_ITERATORS,
    en = jt('iterator'),
    nn = function () {
      return this;
    },
    cn = function (t, e, i, n, c, o, r) {
      !(function (t, e, i) {
        var n = e + ' Iterator';
        (t.prototype = Ne(ji, { next: V(1, i) })), _e(t, n, !1), (Mi[n] = _i);
      })(i, e, n);
      var s,
        l,
        u,
      ...
      if (
        (B &&
          ...
          $i !== Object.prototype &&
            s.next &&
            (zi(s) !== $i &&
              (qi ? qi(s, $i) : 'function' != typeof s[en] && K(s, en, nn)),
            _e(s, I, !0))),
        'values' == c &&
          b &&
          'values' !== b.name &&
        ...
        if (
          ...
          for (u in l) (tn || g || !(u in d)) && yt(d, u, l[u]);
        else Kt({ target: e, proto: !0, forced: tn || g }, l);
      return l;
    },
    on = Ni.charAt,
    rn = bt.set,
    sn = bt.getterFor('String Iterator');
  cn(
    String,
    'String',
    function (t) {
  ...
  var ln = function (t) {
    ...
    In = Array.prototype,
    gn = function (t) {
      return void 0 !== t && (Mi.Array === t || In[an] === t);
    },
    dn = jt('iterator'),
    bn = function (t) {
      if (null != t) return t[dn] || t['@@iterator'] || Mi[Qe(t)];
    },
    yn = jt('iterator'),
    Bn = !1;
  try {
    ...
    { target: 'Array', stat: !0, forced: fn },
    {
      from: function (t) {
        ...
        if (
          ...
          for (i = new l((e = Zt(s.length))); e > d; d++)
            (r = I ? a(s[d], d) : s[d]), be(i, d, r);
        else
          for (
            ...
            (r = I ? un(c, a, [n.value, d], !0) : n.value), be(i, d, r);
        return (i.length = d), i;
      },
    }
  ),
  ...
  var Cn,
    ...
    Qn = xn.isPrototypeOf,
    Rn = jt('toStringTag'),
    An = nt('TYPED_ARRAY_TAG'),
    Jn = Fn && !!qi && 'Opera' !== Qe(h.opera),
    Wn = {
      Int8Array: 1,
      Uint8Array: 1,
      Uint8ClampedArray: 1,
  ...
  for (Cn in Wn) h[Cn] || (Jn = !1);
  if (
    (!Jn || 'function' != typeof Sn || Sn === Function.prototype) &&
    ((Sn = function () {
      throw TypeError('Incorrect invocation');
    }),
    Jn)
  )
    for (Cn in Wn) h[Cn] && qi(h[Cn], Sn);
  if ((!Jn || !vn || vn === xn) && ((vn = Sn.prototype), Jn))
    for (Cn in Wn) h[Cn] && qi(h[Cn].prototype, vn);
  if ((Jn && zi(Gn) !== vn && qi(Gn, vn), f && !J(vn, Rn)))
    for (Cn in (Zn(vn, Rn, {
      get: function () {
        return Q(this) ? this[An] : void 0;
      },
    }),
    Wn))
      h[Cn] && K(h[Cn], An, Cn);
  ...
  !(function (t, e, i) {
    if (f) {
      if (i)
        for (var n in Wn) {
          var c = h[n];
          c && J(c.prototype, t) && delete c.prototype[t];
        }
      (vn[t] && !i) || yt(vn, t, i ? e : (Jn && Un[t]) || e);
    }
  })(
    'slice',
    function (t, e) {
      for (
        var i = Yn.call(wn(this), t, e),
          n = (function (t, e) {
            var i,
              n = N(t).constructor;
            return void 0 === n || null == (i = N(n)[Hn]) ? e : le(i);
  ...
  var kn = jt('unscopables'),
    Nn = Array.prototype;
  null == Nn[kn] && E.f(Nn, kn, { configurable: !0, value: Ne(null) });
  var Tn = function (t) {
      Nn[kn][t] = !0;
    },
    ...
    Dn = Gt.includes,
    On = (function (t, e) {
      if (J(Kn, t)) return Kn[t];
      e || (e = {});
      var i = [][t],
        n = !!J(e, 'ACCESSORS') && e.ACCESSORS,
        c = J(e, 0) ? e[0] : zn,
        o = J(e, 1) ? e[1] : void 0;
      return (Kn[t] =
        !!i &&
        !m(function () {
          if (n && !f) return !0;
          var t = { length: -1 };
          n ? En(t, 1, { enumerable: !0, get: zn }) : (t[1] = 1),
            i.call(t, c, o);
        }));
    })('indexOf', { ACCESSORS: !0, 1: 0 });
  Kt(
    { target: 'Array', proto: !0, forced: !On },
    {
      includes: function (t) {
  ...
  var Pn = !m(function () {
    ...
    Mn = B(function (t) {
      var e = E.f,
        ...
        r = (t.exports = {
          ...
          onFreeze: function (t) {
            return Pn && r.REQUIRED && c(t) && !J(t, i) && o(t), t;
          },
        });
      rt[i] = !0;
    }),
    ...
    _n = function (t, e, i) {
      var n,
        ...
        b = ue(e, a, 1 + I + d),
        y = function (t) {
          return n && ln(n), new jn(!0, t);
        },
        B = function (t) {
          return I
            ? (N(t), d ? b(t[0], t[1], y) : b(t[0], t[1]))
            : d
            ? b(t, y)
            : b(t);
        };
      if (g) n = t;
        ...
        if ('function' != typeof (c = bn(t)))
          throw TypeError('Target is not iterable');
        if (gn(c)) {
          for (o = 0, r = Zt(t.length); r > o; o++)
            if ((s = B(t[o])) && s instanceof jn) return s;
          return new jn(!1);
        }
        n = c.call(t);
      }
      for (l = n.next; !(u = l.call(n)).done; ) {
        ...
        if ('object' == typeof s && s && s instanceof jn) return s;
      }
      return new jn(!1);
    },
    qn = function (t, e, i) {
          ...
          a = function (t) {
            ...
            yt(
              ...
              'add' == t
                ...
                : 'delete' == t
                ? function (t) {
                    return !(c && !Q(t)) && e.call(this, 0 === t ? 0 : t);
                  }
                : 'get' == t
                ? function (t) {
                    return c && !Q(t) ? void 0 : e.call(this, 0 === t ? 0 : t);
                  }
                : 'has' == t
                ? function (t) {
                    return !(c && !Q(t)) && e.call(this, 0 === t ? 0 : t);
        ...
        if (
          ...
          b ||
            (((l = e(function (e, i) {
              ...
              return null != i && _n(i, c[o], { that: c, AS_ENTRIES: n }), c;
            })).prototype = s),
            (s.constructor = l)),
          ...
          getConstructor: function (t, e, i, n) {
            var c = t(function (t, o) {
                qn(t, c, e),
                  ...
                  f || (t.size = 0),
                  null != o && _n(o, t[n], { that: t, AS_ENTRIES: i });
              }),
              o = cc(e),
              r = function (t, e, i) {
                var n,
    ...
    rc = bt.set,
    sc = bt.getterFor('Array Iterator'),
    lc = cn(
      Array,
      'Array',
      function (t, e) {
        rc(this, { type: 'Array Iterator', target: x(t), index: 0, kind: e });
      },
      function () {
        var t = sc(this),
          e = t.target,
        ...
        Cc._immediateFn(function () {
          ...
          if (null !== i) {
            ...
            try {
              ...
              return void Vc(e.promise, t);
            }
            Zc(e.promise, n);
          } else (1 === t._state ? Zc : Vc)(e.promise, t._value);
        }))
      : t._deferreds.push(e);
  }
  function Zc(t, e) {
    try {
      ...
      if (e && ('object' == typeof e || 'function' == typeof e)) {
        var i = e.then;
        if (e instanceof Cc) return (t._state = 3), (t._value = e), void Uc(t);
  ...
  function Uc(t) {
    ...
    for (var e = 0, i = t._deferreds.length; e < i; e++) Fc(t, t._deferreds[e]);
    t._deferreds = null;
  }
  function Xc(t, e, i) {
  ...
  (Cc.prototype.catch = function (t) {
    ...
    (Cc.prototype.then = function (t, e) {
      ...
      return Fc(this, new Xc(t, e, i)), i;
    }),
    (Cc.prototype.finally = Bc),
    (Cc.all = function (t) {
      return new Cc(function (e, i) {
    ...
    (Cc.race = function (t) {
      return new Cc(function (e, i) {
        ...
        for (var n = 0, c = t.length; n < c; n++) Cc.resolve(t[n]).then(e, i);
      });
    }),
    (Cc._immediateFn =
  ...
  'function' != typeof Sc.Promise
    ? (Sc.Promise = Cc)
    : Sc.Promise.prototype.finally
    ? Sc.Promise.allSettled || (Sc.Promise.allSettled = pc)
    : (Sc.Promise.prototype.finally = Bc),
    (function (t) {
      function e() {}
      function i(t, e) {
        if (
              ...
              },
              {
                ...
                value: function (t) {
                  'abort' === t.type &&
                    ...
                    u(c(l.prototype), 'dispatchEvent', this).call(this, t);
                },
              },
            ]),
            l
  ...
  var xc = y(
                    ...
                    case 0:
                      return (
                        ...
                        null === (r = i.getItem(o))
                          ...
                          ? [3, 2]
                          : [4, vc.default().lock(r.iat)]
                      );
                    case 1:
                      n.sent(),
                        this.acquiredIatSet.delete(r.iat),
                        i.removeItem(o),
                        vc.default().unlock(r.iat),
                        t.notifyWaiters(),
                        (n.label = 2);
                    case 2:
                      return [2];
    ...
    Ac = { name: 'auth0-spa-js', version: '1.13.5' },
    Jc = (function (t) {
      function e(i, n) {
            ...
            if (
              ...
              i && i.close(),
                t.data.response.error
                  ? c(Jc.fromPayload(t.data.response))
                  : n(t.data.response),
                clearTimeout(l),
                window.removeEventListener('message', r, !1),
                setTimeout(s, 2e3);
      ...
      return new Promise(function (t, i) {
        var n,
          c = setTimeout(function () {
            i(new wc(o)), window.removeEventListener('message', n, !1);
        ...
        (n = function (e) {
          if (e.data && 'authorization_response' === e.data.type) {
            if (
              ...
              return i(Jc.fromPayload(e.data.response));
            t(e.data.response);
          }
        }),
    ...
    Tc = function () {
      var t =
        ...
        e = '';
      return (
        Array.from(kc().getRandomValues(new Uint8Array(43))).forEach(function (
          i
        ) {
            ...
            case 1:
              return [
                ...
                new Promise(function (t, e) {
                  ...
                  for (var s in (i.open(a.method || 'get', u, !0),
                  (i.onload = function () {
                    i
                  ...
                  (i.onerror = e),
                  (i.withCredentials = 'include' == a.credentials),
                  a.headers))
                    i.setRequestHeader(s, a.headers[s]);
                  i.send(a.body || null);
                })),
              ];
            case 2:
              return (r = l.sent()), (s = { ok: r.ok }), [4, r.json()];
            case 3:
              return [2, ((s.json = l.sent()), s)];
          }
          var u, a, I, g;
        });
      });
    },
    Mc = function (t, e, i, n, c, o) {
      void 0 === o && (o = 1e4);
      var r,
      ...
      return Promise.race([
        ...
        new Promise(function (t, e) {
          r = setTimeout(function () {
            s.abort(), e(new Error("Timeout when executing 'fetch'"));
          }, o);
        }),
      ]).finally(function () {
        clearTimeout(r);
  ...
  function jc(t, e, i, n, c, o) {
    return g(this, void 0, void 0, function () {
      var r, s, l, u, a, g, b, y;
      return d(this, function (d) {
        switch (d.label) {
          case 0:
            (r = null), (l = 0), (d.label = 1);
          case 1:
            if (!(l < 3)) return [3, 6];
            d.label = 2;
          case 2:
            return d.trys.push([2, 4, , 5]), [4, Mc(t, i, n, c, o, e)];
          case 3:
            return (s = d.sent()), (r = null), [3, 6];
          case 4:
          ...
          case 6:
            ...
            if (
              ...
              throw new Jc(
                g || 'request_error',
                b || 'HTTP error. Unable to fetch ' + t
              );
            return [2, y];
        }
      });
  ...
  var _c = function (t) {
    ...
    qc = function () {
      ...
      return _c(t.join(' ').trim().split(/\s+/)).join(' ');
    };
  function $c(t, e) {
    var i = t.baseUrl,
      n = t.timeout,
      ...
      o = t.scope,
      r = t.auth0Client,
      s = I(t, ['baseUrl', 'timeout', 'audience', 'scope', 'auth0Client']);
    return g(this, void 0, void 0, function () {
      var t, l;
              ...
              jc(
                ...
                o,
                {
                  ...
                  headers: {
                    ...
                    'Auth0-Client': btoa(JSON.stringify(r || Ac)),
                  },
                },
                e
              ),
  ...
  y(uo), uo.encode, uo.parse, uo.getAll;
  var ao = uo.get,
    Io = uo.set,
    go = uo.remove,
    bo = {
    ...
    yo = {
      get: function (t) {
        return bo.get(t) || bo.get('_legacy_' + t);
      },
      save: function (t, e, i) {
        var n = {};
        'https:' === window.location.protocol && (n = { secure: !0 }),
          (n.expires = i.daysUntilExpire),
          Io('_legacy_' + t, JSON.stringify(e), n),
          bo.save(t, e, i);
      },
      remove: function (t) {
        bo.remove(t), bo.remove('_legacy_' + t);
      },
    },
    Bo = {
      get: function (t) {
  ...
  var po,
    ...
    Zo = (function () {
      function t(t) {
        ...
        if (
          ...
          (this.cookieStorage = !1 === t.legacySameSiteCookie ? bo : yo),
        ...
        var n,
          c,
          o = t.useCookiesForTransactions ? this.cookieStorage : Bo;
        (this.cache = Fo(this.cacheLocation)()),
          (this.scope = this.options.scope),
          (this.transactionManager = new ro(o)),
          ...
          this.options.useRefreshTokens &&
            (this.scope = qc(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
      ...
      return (
        (t.prototype._url = function (t) {
          var e = encodeURIComponent(
            btoa(JSON.stringify(this.options.auth0Client || Ac))
          );
        ...
        (t.prototype._getParams = function (t, e, i, n, c) {
          ...
          return a(a(a({}, r), t), {
            scope: qc(this.defaultScope, this.scope, t.scope),
            response_type: 'code',
            response_mode: 'query',
            state: e,
            nonce: i,
        ...
        (t.prototype._authorizeUrl = function (t) {
          return this._url('/authorize?' + Kc(t));
        }),
        (t.prototype._verifyIdToken = function (t, e, i) {
          return (function (t) {
            ...
            var e = (function (t) {
              ...
              var o = JSON.parse(Dc(n)),
                r = { __raw: t },
                s = {};
              return (
                Object.keys(o).forEach(function (t) {
                  (r[t] = o[t]), lo.includes(t) || (s[t] = o[t]);
                }),
                {
                  encoded: { header: i, payload: n, signature: c },
                  header: JSON.parse(Dc(i)),
                  claims: r,
                  user: s,
                }
              );
            ...
            if (t.max_age && !so(e.claims.auth_time))
              throw new Error(
                ...
                switch (d.label) {
                  ...
                  case 1:
                    return (
                      ...
                      (g = this._getParams(n, c, o, l, e)),
                      (b = this._authorizeUrl(g)),
                ...
                switch (d.label) {
                  ...
                  case 1:
                    return (
                      ...
                      (u = this._authorizeUrl(
                        a(a({}, l), { response_mode: 'web_message' })
                      )),
                      [
                        4,
                        Yc(
                  ...
                  case 3:
                    return (
                      (b = d.sent()),
                      (y = t.organization || this.options.organization),
                      (B = this._verifyIdToken(b.id_token, c, y)),
                      (p = a(a({}, b), {
                        decodedToken: B,
                        scope: l.scope,
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (c) {
                return (
                  ...
                  (i = qc(this.defaultScope, this.scope, t.scope)),
                  [
                    2,
                    (n = this.cache.get(
                      new to({
            ...
            return d(this, function (i) {
              switch (i.label) {
                ...
                case 2:
                  return i.sent(), [3, 4];
                case 3:
                  if (((e = i.sent()), !Rc.includes(e.error))) throw e;
                  return [3, 4];
                case 4:
                  return [2];
              }
          ...
          return (
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (o) {
                return (
                  (e = a(
                    a({ audience: this.options.audience, ignoreCache: !1 }, t),
                    { scope: qc(this.defaultScope, this.scope, t.scope) }
                  )),
                  (i = e.ignoreCache),
                  (n = I(e, ['ignoreCache'])),
                  [
                    2,
                    ((r = function () {
                      return c._getTokenSilently(a({ ignoreCache: i }, n));
                    }),
                    (s =
                ...
                switch (l.label) {
                  ...
                  case 6:
                    return (
                      (o = r),
                      this.cache.save(
                        a({ client_id: this.options.client_id }, o)
                      ),
                      this.cookieStorage.save('auth0.is.authenticated', !0, {
                        daysUntilExpire: this.sessionCheckExpiryDays,
                      }),
                ...
                switch (i.label) {
                  case 0:
                    return (
                      ...
                      (t.scope = qc(this.defaultScope, this.scope, t.scope)),
                      (e = a(a({}, Qc), e)),
        ...
        (t.prototype.buildLogoutUrl = function (t) {
          ...
          var e = t.federated,
            i = I(t, ['federated']),
            n = e ? '&federated' : '';
          return this._url('/v2/logout?' + Kc(i)) + n;
        }),
        ...
        (t.prototype._getTokenFromIFrame = function (t) {
          return g(this, void 0, void 0, function () {
            var e, i, n, c, o, r, s, l, u, g, b, y, B, p, h;
            return d(this, function (d) {
              switch (d.label) {
                case 0:
                  return (e = Ec(Tc())), (i = Ec(Tc())), (n = Tc()), [4, zc(n)];
                case 1:
                  (c = d.sent()),
                    (o = Oc(c)),
                    (r = this._getParams(
                ...
                case 2:
                  return (
                    d.trys.push([2, 5, , 6]), [4, Lc(s, this.domainUrl, l)]
                  );
                case 3:
                ...
                case 4:
                  return (
                    (B = d.sent()),
                    (p = this._verifyIdToken(B.id_token, i)),
                    [
                      2,
                      a(a({}, B), {
                        decodedToken: p,
    ...
    Vo = { isAuthenticated: !1, isLoading: 'undefined' != typeof window },
    Uo = function () {
      throw new Error('You forgot to wrap your component in <Auth0Provider>.');
    },
    Xo = c(c({}, Vo), {
      buildAuthorizeUrl: Uo,
      buildLogoutUrl: Uo,
      getAccessTokenSilently: Uo,
      getAccessTokenWithPopup: Uo,
      getIdTokenClaims: Uo,
      loginWithRedirect: Uo,
      loginWithPopup: Uo,
      logout: Uo,
    }),
    Go = e.createContext(Xo),
    So = (function (t) {
      function e(e, i) {
    ...
    Ro = function (t) {
      return function (e) {
        return 'error' in e
          ? new So(e.error, e.error_description)
          : e instanceof Error
          ? e
          : new Error(t);
      };
  ...
  (t.Auth0Context = Go),
    (t.Auth0Provider = function (t) {
      var n,
        ...
        I = void 0 === a ? Ho : a,
        g = o(t, ['children', 'skipRedirectCallback', 'onRedirectCallback']),
              ...
              switch (n.label) {
                case 0:
                  return (
                    ...
                    !((vo.test(c) && xo.test(c)) || Qo.test(c)) || u
                      ? [3, 2]
                ...
                case 6:
                  return (
                    (i = n.sent()), B({ type: 'ERROR', error: Ao(i) }), [3, 7]
                  );
                case 7:
                  return [2];
              }
      ...
      var p = e.useCallback(
          function (t) {
            return d.buildAuthorizeUrl(t);
          },
          [d]
        ),
        h = e.useCallback(
          function (t) {
            return d.buildLogoutUrl(t);
          },
          [d]
        ),
        m = e.useCallback(
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return s(this, function (c) {
                switch (c.label) {
                  ...
                  case 3:
                    return (
                      (i = c.sent()), B({ type: 'ERROR', error: Ao(i) }), [2]
                    );
                  case 4:
                    return [4, d.getUser()];
                  case 5:
        ...
        F = null === (n = y.user) || void 0 === n ? void 0 : n.updated_at,
        Z = e.useCallback(
          function (t) {
            return r(void 0, void 0, void 0, function () {
              var e, i, n;
      ...
      return i.createElement(
        Go.Provider,
        {
          value: c(c({}, y), {
            buildAuthorizeUrl: p,
            buildLogoutUrl: h,
            getAccessTokenSilently: Z,
            getAccessTokenWithPopup: V,
            getIdTokenClaims: U,
            loginWithRedirect: m,
            loginWithPopup: f,
            logout: C,
    ...
    (t.withAuth0 = function (t) {
      return function (e) {
        return i.createElement(Go.Consumer, null, function (n) {
